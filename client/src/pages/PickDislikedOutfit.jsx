  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const endpoint = weatherFilters
        ? `http://localhost:9000/mycloset/filter-disliked-outfits-by-weather/${user_id}`
        : `http://localhost:9000/mycloset/filter-disliked-outfits/${user_id}`;
...
export default PickDislikedOutfit;
