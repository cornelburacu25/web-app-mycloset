...
const OutfitCanvasPicker = ({ width, height, selectedClothings }) => {
  if (!selectedClothings || typeof selectedClothings !== 'object') {
    ...
    <Stage width={width} height={height}>
      <Layer>
        {Object.keys(categoryPositions).map((category) => {
          const clothing = selectedClothings[category];
          return (
            clothing && (
              <ClothingImage
                key={category}
...
export default OutfitCanvasPicker;
